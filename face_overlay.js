...
function calcPartsPositions(r, w, h) {
  ...
  */
  ...
  o['head'] = {
    ...
    gy: r[0][1] + (r[41][1] - r[7][1]) + (r[0][1] - r[27][1])*2,
    rad: 0,
    w: (r[14][0] - r[0][0])*2,
    h: (r[14][0] - r[0][0])*2/10*6,
  }
  */
  o['head'] = {
    gx: r[1][0] + (r[1][0] - r[13][0])*(0.4) + (r[33][0] - r[37][0])*3,
    gy: r[1][1] + (r[1][1] - r[13][1])*(0.4) + (r[33][1] - r[37][1])*3,
    rad: Math.atan((r[13][1] - r[1][1])/(r[13][0] - r[1][0])),
    w: Math.sqrt((r[13][0] - r[1][0])**2 + (r[13][1] - r[1][1])**2)*1.8,
